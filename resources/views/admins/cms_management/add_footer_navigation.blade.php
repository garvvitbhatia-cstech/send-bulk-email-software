...
@section('title', 'Add Footer Navigation')
@section('content')
<section class="content">
   <div class="container-fluid">
   <div class="block-header">
      <h2>Add Footer Navigation</h2>
   </div>
   <!-- Input -->
               ...
               <div class="row clearfix">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="card">
                        ...
                        <div class="body">
                           {{ Form::open(array('url' => array('/admins/add-footer-navigation'),'id' => 'pageForm', 'method' => 'post', 'files' => true)) }}
                           @csrf
