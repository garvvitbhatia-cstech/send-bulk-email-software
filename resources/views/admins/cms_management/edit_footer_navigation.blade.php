...
@section('title', 'Edit Footer Navigation')
@section('content')
<section class="content">
   <div class="container-fluid">
   <div class="block-header">
      <h2>Edit Footer Navigation</h2>
   </div>
   <!-- Input -->
               ...
               <div class="row clearfix">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="card">
                        ...
                        <div class="body">
                           {{ Form::open(array('url' => array('/admins/edit-footer-navigation',Crypt::encrypt($navigation->id)),'id' => 'pageForm', 'method' => 'post', 'files' => true)) }}
                           @csrf
                           <div class="form-group form-float">
                              ...
                              <div class="form-line">
                                 ...
                                 @php
                                 	echo Helper::getNavigationCategory($footerNavigationList,$navigation->parent_id,$navigation->id);
                                 @endphp
                                 </select>
                              </div>
                              @error('parent_id')
