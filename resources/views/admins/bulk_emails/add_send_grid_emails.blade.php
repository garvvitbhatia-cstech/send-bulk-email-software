    ...
    <div class="row clearfix">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="">
          <div class="body">
            <div class="row clearfix">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> @include('../flash-message')
                <div class="card"> {{ Form::open(array('url' => array('/admins/add-send-grid-email'),'id' => 'pageForm', 'method' => 'post', 'files' => true)) }}
                  @csrf
                ...
                <div class="card">
                  <div class="body">
                    ...
                    <div class="form-group form-float">
                      ...
                      <div class="form-line">
                        <input type="email" id="test_email_recepients" name="test_email_recepients" onkeyup="checkError(this.id);" value="{{old('test_email_recepients')}}" confirmation="false" class="form-control">
                      </div>
                    ...
                    <div class="form-group form-float">
                      ...
                      <div class="form-line">
                        <input type="text" id="sendgrid_limit" name="sendgrid_limit" onkeyup="checkError(this.id);" value="{{old('sendgrid_limit')}}" confirmation="false" class="form-control">
                      </div>
                    ...
                    <div class="form-group form-float">
                      ...
                      <div class="form-line">
                        <input type="text" id="sendgrid_api_key" name="sendgrid_api_key" onkeyup="checkError(this.id);" value="{{old('sendgrid_api_key')}}" confirmation="false" class="form-control">
                      </div>
