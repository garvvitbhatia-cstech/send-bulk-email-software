...
@section('title', 'Add Smtp Email Mime')
@section('content')
<section class="content" style="margin: 64px 15px 0 0;">
  <div class="container-fluid">
    <div class="block-header">
      <h2>Add Smtp Email Mime</h2>
    </div>
    <!-- Input -->
            ...
            <div class="row clearfix">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card"> @include('../flash-message')
                  <div class="body"> {{ Form::open(array('url' => array('/admins/add-smtp-email-mime'),'id' => 'pageForm', 'method' => 'post', 'files' => true)) }}
                    @csrf
                  ...
                  <div class="body">
                    ...
                    <div class="form-group form-float">
                      ...
                      <div class="demo-radio-button form-line">
                        ...
                        <input {{old('type') == 'Mime'?'checked':''}} name="type" value="Mime" type="radio" class="with-gap radio" id="mime">
