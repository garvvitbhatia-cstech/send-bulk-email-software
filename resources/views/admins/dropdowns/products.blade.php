        ...
        <div class="card">
          ...
          <div class="header">
            ...
            <ul class="header-dropdown">
              <li class="dropdown">
                <a href="{{url('admins/add-product')}}"><button type="button" class="btn btn-warning btn-lg waves-effect">Add Product</button></a>
              </li>
            </ul>
          </div>          
          <div class="body">
            ...
            <div class="dataTables_wrapper form-inline dt-bootstrap">
              <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                ...
                <tr>
                  ...
                  <td>{{ date("F jS, Y h:i A",strtotime($product->created_at)); }}</td>
                  <td>
