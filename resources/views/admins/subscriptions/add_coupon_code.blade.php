...
<script src="{{ URL::asset('public/assets/js/admin/datetime/jquery.datetimepicker.js') }}"></script>
<link href="{{ URL::asset('public/assets/css/admin/datetime/jquery.datetimepicker.min.css') }}" rel="stylesheet"/>
